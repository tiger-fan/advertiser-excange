...
require(["dojo/parser", "esri/map", "esri/tasks/locator", "esri/geometry/Extent", "esri/geometry/webMercatorUtils", 
		"extras/ClusterLayer", "esri/tasks/query", "esri/tasks/QueryTask", "esri/geometry/Multipoint", "esri/SpatialReference",
		"dojo/dom", "dojo/on", "dojo/domReady!"],

function(parser, Map, Locator, Extent, webMercatorUtils, ClusterLayer, Query, QueryTask, Multipoint, SpatialReference, dom, on) {
	parser.parse();
	var initial = true;
	var FIPS = [];
