require(["dojo/parser", "esri/map", "extras/ClusterLayer", "esri/tasks/query", "esri/tasks/QueryTask", "esri/geometry/Multipoint", "esri/SpatialReference", "dojo/dom", "dojo/on", "esri/dijit/Geocoder", "dijit/layout/ContentPane", "dijit/layout/BorderContainer", "esri/geometry", "dojo/domReady!"], function(parser, Map, ClusterLayer, Query, QueryTask, Multipoint, SpatialReference, dom, on, Geocoder, ContentPane, BorderContainer, geometry) {
  
  describe("arcgis.js", function() {
    var arcgisfunc ;
    beforeEach(function() {
      arcgisfunc = function (parser, Map, ClusterLayer, Query, QueryTask, Multipoint, SpatialReference, dom, on, Geocoder, ContentPane, BorderContainer, geometry) {
        parser.parse();
        var initial = true;
        var FIPS = [];
