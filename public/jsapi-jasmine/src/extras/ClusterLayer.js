define(["dojo/_base/declare", "esri/layers/graphics", "esri/layers/GraphicsLayer"], function(declare, Graphics, GraphicsLayer){
  return declare(GraphicsLayer, {
    ...
    this._singleSym = options.singleSymbol || new esri.symbol.PictureMarkerSymbol("http://static.arcgis.com/images/Symbols/Shapes/OrangePin1LargeB.png", 20, 20).setOffset(0, 0);/*new sms("circle", 12, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID,
